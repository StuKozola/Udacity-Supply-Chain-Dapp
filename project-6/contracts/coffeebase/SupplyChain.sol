...
contract SupplyChain is FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
  ...
  modifier paidEnough(uint _price) { 
    require(msg.value >= _price, "Amount paid is insufficient"); 
    _;
  }
  ...
  modifier harvested(uint _upc) {
    require(items[_upc].itemState == State.Harvested, "Coffee has not been harvested");
    _;
  }
  ...
  checkValue(_upc)
    ...
    items[upc].originFarmerID.transfer(items[_upc].productPrice);
    // emit the appropriate event
    emit Sold(_upc);
  }
